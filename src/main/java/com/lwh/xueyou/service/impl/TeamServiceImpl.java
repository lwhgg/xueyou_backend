package com.lwh.xueyou.service.impl;
...
import com.lwh.xueyou.mapper.TeamMapper;
import com.lwh.xueyou.model.domain.User;
import com.lwh.xueyou.model.domain.UserTeam;
import com.lwh.xueyou.model.dto.TeamQuery;
import com.lwh.xueyou.model.enums.TeamStatusEnum;
...
import com.lwh.xueyou.service.TeamService;
import com.lwh.xueyou.service.UserService;
import com.lwh.xueyou.service.UserTeamService;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public boolean updateTeam(@RequestBody TeamUpdateRequest teamUpdateRequest, User loginUser) {
        ...
        if (StringUtils.isNotBlank(password)) {
            if (TeamStatusEnum.PUBLIC.equals(statusEnum) || TeamStatusEnum.PRIVATE.equals(statusEnum)) {
                throw new BusinessException(ErrorCode.PARAMS_ERROR, "只有加密房间才能设置密码");
            }
        }
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock("xueyou:join_team");
        try {
            // 抢到锁并执行
            while (true) {
